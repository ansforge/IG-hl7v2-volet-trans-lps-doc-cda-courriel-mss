...
<blockquote class="stu-note">
    <p>
    <b>Point d'attention :</b> la grammaire du champ <code>Disposition:</code> (<a href="https://datatracker.ietf.org/doc/html/rfc8098#section-3.2.6">RFC 8098 §3.2.6</a>) n'admet, après le <code>/</code>, qu'un modificateur unique : le littéral <code>error</code>, ou un <code>extension-disposition-modifier</code> défini comme un <code>Atom</code> au sens de la <a href="https://datatracker.ietf.org/doc/html/rfc5322#section-3.2.3">RFC 5322 §3.2.3</a> — jeton qui n'admet ni le caractère « : » ni les espaces. Le texte de diagnostic dispose, quant à lui, de son propre champ <code>Error:</code>. La forme retenue par le volet place donc dans le modificateur ce que la RFC répartit sur deux champs :
    </p>
    <pre>Forme retenue par le volet :
Disposition: automatic-action/MDN-sent-automatically; processed/Error: 902^Identifiant de patient inconnu

Forme conforme à la grammaire de la RFC 8098 :
Disposition: automatic-action/MDN-sent-automatically; processed/error
Error: 902^Identifiant de patient inconnu</pre>
    <p>
    Un outillage MDN standard ne peut pas interpréter le modificateur de la première forme : il ne retiendra que « <code>processed</code> » et le code erreur sera perdu.
    <br><br>
