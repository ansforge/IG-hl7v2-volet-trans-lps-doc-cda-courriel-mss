...
* Revue des exemples de MDN et de courriel standard ([35](https://github.com/ansforge/IG-hl7v2-volet-trans-lps-doc-cda-courriel-mss/issues/35))
  * [Structure du MDN](struct-msg-mdn.html) :
    ...
    * énoncé de l'objectif poursuivi en cas d'erreur : le destinataire du MDN doit disposer de tous les éléments nécessaires au retraitement — identifier le document et l'usager, corriger la cause de l'échec, soumettre à nouveau les documents, le cas échéant en sollicitant l'émetteur initial — sans avoir à retrouver le courriel d'origine par un autre moyen ; **aucun élément du courriel d'origine ne doit être perdu**
