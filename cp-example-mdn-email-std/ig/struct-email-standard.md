...
>  **Point d'attention :** cette duplication est volontaire, et distingue le courriel standard du [MDN](struct-msg-mdn.md), dont les pièces jointes ne figurent que dans la troisième partie du « multipart/report ». 

 Le MDN est destiné à un traitement automatisé par la PFI réceptrice, dans une structure dont les [RFC 6522](https://datatracker.ietf.org/doc/html/rfc6522#section-4) et [RFC 8098](https://datatracker.ietf.org/doc/html/rfc8098#section-3) fixent le nombre et le rôle des parties : le courriel d'origine y est restitué en un seul endroit. 
