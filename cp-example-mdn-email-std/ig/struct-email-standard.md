...
On notera que le courriel d’origine encapsulé ne porte pas d’entête `Disposition-Notification-To` : c’est précisément la raison pour laquelle la notification prend la forme d’un courriel standard et non d’un [MDN](struct-msg-mdn.md).
...
Veuillez vérifier les informations fournies et soumettre à nouveau les
documents après correction. Si le problème persiste, contactez notre
service technique.
